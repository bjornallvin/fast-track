...
const CheckinForm: React.FC<CheckinFormProps> = ({
  ...
  const form = (
    <form onSubmit={handleSubmit}>
      ...
      <div className="mt-5">
        <label className="font-medium text-[15px] block mb-1.5" htmlFor="checkin-note">
        ...
        <textarea
          ...
          rows={2}
          placeholder="Sleep last night, cravings, wins, how you're feeling…"
          className="w-full px-3.5 py-2.5 border border-line rounded-xl bg-white resize-y text-[15px]"
        />
      </div>
  ...
  return (
    ...
    >
      <div
        className="bg-paper rounded-2xl shadow-xl p-6 sm:p-7 w-full max-w-xl max-h-[92vh] overflow-y-auto"
